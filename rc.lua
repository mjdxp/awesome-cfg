...
--default beautiful.init(gears.filesystem.get_themes_dir() .. "default/theme.lua")
    beautiful.init("/home/mjd/.config/awesome/themes/default/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Each screen has its own tag table. originally: awful.tag({ "1", "2", "3", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
--          "Tor Browser", -- Needs a fixed window size to avoid fingerprinting by screen size.
    ...
    -- Titlebars enabled is by default true
    },
...
awful.spawn.with_shell("compton --config ~/.config/compton.conf -b")
awful.spawn.with_shell("/usr/lib/policykit-1-gnome/polkit-gnome-authentication-agent-1")
--awful.spawn.--with_shell("nitrogen --restore")
awful.spawn.with_shell("aplay ~/.config/awesome/start.wav")
